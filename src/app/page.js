          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                liveUrl: "https://portfolio-dun-two-60.vercel.app", // ⭐ PERSONALIZZA: URL del progetto live
                codeUrl: "https://github.com/Tizzzio/Portfolio", // ⭐ PERSONALIZZA: URL del repository
              },
            ].map((project, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-gray-200 transform hover:-translate-y-2 h-full flex flex-col"
              >
