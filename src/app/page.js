    ...
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <a href="#contatti" className="border border-blue-600 text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors">
              Contattami
            </a>
          </div>
        </div>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Chi Sono</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-600 mb-4">Sono uno sviluppatore web con esperienza in tecnologie moderne come React, Next.js e Tailwind CSS.</p>
              <p className="text-gray-600 mb-6">
                Mi piace creare esperienze web intuitive e performanti, sempre attento alle ultime tendenze del settore.
              </p>
            ...
            <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
              <span className="text-gray-500">La tua foto</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Sezione Progetti */}
      <section id="progetti" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">I Miei Progetti</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div className="bg-gray-200 h-48 flex items-center justify-center">
                  <span className="text-gray-500">Immagine Progetto {i}</span>
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Progetto {i}</h3>
                  <p className="text-gray-600 mb-4">Descrizione del progetto {i}. Tecnologie utilizzate e obiettivi raggiunti.</p>
